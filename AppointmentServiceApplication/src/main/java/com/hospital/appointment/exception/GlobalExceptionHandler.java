...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Object>> handleAppointmentNotFound(AppointmentNotFoundException ex) {
    ...
    public ResponseEntity<ApiResponse<Object>> handleSlotNotFound(SlotNotFoundException ex) {
        ApiResponse<Object> response = new ApiResponse<>(
            false,
            ex.getMessage(),
            null,
