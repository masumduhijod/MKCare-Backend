...
public class TenantRoutingDataSource extends AbstractRoutingDataSource {
    ...
    protected DataSource determineTargetDataSource() {
        ...
        synchronized (tenantDataSources) {
            if (!tenantDataSources.containsKey(tenantId)) {
                ...
                System.out.println("✅ Connected to database: " + tenant.getDbName() + " for clinic: " + tenant.getClinicName());
            }
        }
    ...
    private void ensureSchemaUpdated(DataSource dataSource, String dbName) {
        ...
        try {
            addColumnIfNotExists(jt, dbName, "doctors", "follow_up_days_limit", "INT DEFAULT 7");
